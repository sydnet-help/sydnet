---
title: "SOC224: Qualitative Analysis (Theory)"
...
linktitle: "Qualitative Analysis (Theory)"
menu:
  docs:
    parent: SOC224
    weight: 10
...
# 2. Basic tools
## 2.1 Thematic coding <br/> : Finding patterns in your data
...
## 2.2 Coding
### 2.2.1 Open coding <br/> : The first read of your data
...
### 2.2.2 Codebook & axial coding <br/> : The real analysis 
...
### 2.2.4 Selective coding <br/> : Picking your illustrative examples  
...
## 2.3 Analytic memos <br/> : Storing your random ideas
...
## 2.4 Saturation <br/> : Knowing when you can stop
...
## 2.5 Writing up <br/> : Translating for an audience  
...
### 2.5.1 Three to ten themes (subheadings) <br/> : Not a rule, but almost always true 
...
### 2.5.2 Theme structure: <br/> : Subheading, explanation, quote 
...
### 2.5.3 Tables and figures <br/> : When you want to turn words into numbers 
...
## 3.1 Inductive theorising <br/> : Letting theory emerge from data 
...
## 3.2 Deductive theorising <br/> : Fitting data to an existing theory  
...
## 3.3 Analytic comparison <br/> : Logic and truth tables
...
## 3.4 Narrative or sequence analysis <br/> : Themes as stages in a process  
