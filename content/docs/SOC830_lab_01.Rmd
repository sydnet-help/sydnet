...
```{r, echo=FALSE, fig.cap="<Figure 1-1>", out.width = '80%', fig.align = "center"}
knitr::include_graphics("SOC830_lab01_01.png")
```
...
```{r, echo=FALSE, fig.cap="<Figure 1-2>", out.width = '80%', fig.align = "center"}
knitr::include_graphics("SOC830_lab01_02.png")
```

Then, you will see a new pane in the RStudio (See <Figure 1-3>).

```{r, echo=FALSE, fig.cap="<Figure 1-3>", out.width = '80%', fig.align = "center"}
knitr::include_graphics("SOC830_lab01_03.png")
```
...
```{r, echo=FALSE, fig.cap="<Figure 1-4>", out.width = '80%', fig.align = "center"}
knitr::include_graphics("SOC830_lab01_04.png")
```
...
```{r, echo=FALSE, fig.cap="<Figure 1-5>", out.width = '80%', fig.align = "center"}
knitr::include_graphics("SOC830_lab01_05.png")
```
...
```{r, echo=FALSE, fig.cap="<Figure 1-6>", out.width = '80%', fig.align = "center"}
knitr::include_graphics("SOC830_lab01_06.png")
```
...
```{r, echo=FALSE, fig.cap="<Figure 1-7>", out.width = '80%', fig.align = "center"}
knitr::include_graphics("SOC830_lab01_07.png")
```
...
```{r, echo=FALSE, fig.cap="<Figure 1-7>", out.width = '80%', fig.align = "center"}
knitr::include_graphics("SOC830_lab01_08.png")
```
