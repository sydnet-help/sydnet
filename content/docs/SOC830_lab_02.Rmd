...
<span style="color:cyan">**Note**</span>: It is recommended to update installed R packages. An easy way to update them is to click on **Update** in the **Package** tab.
...
<span style="color:cyan">**Note**</span>: Installed packages can be updated by an R code. For example, if you want to update the  _gmodels_ package. execute the following code in your R Console:
```{r eval=FALSE, echo=TRUE}
...
<span style="color:cyan">**Note**</span>: If you are not sure about what working directory is, see ["Setting your default working directory"](https://methods101.com/docs/soc830_lab_01/#setting-your-default-working-directory) in Lab 1.
...
* <span style="color:red">_**mydata**_</span>_ is a name of data I assign. You can assign other names as well.
* <span style="color:red">**<-**</span> has the same meaning as an equal sign(=).
* _<span style="color:red">_**read.csv("file name")**_</span> is a code for importing CSV files. You need to specify your file name between the parentheses.
