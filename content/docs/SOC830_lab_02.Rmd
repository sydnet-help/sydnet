...
* <span style="color:red">**mydata**</span>_ is a name of data I assign. You can assign other names as well.
* <span style="color:red">**<-**</span> has the same meaning as an equal sign(=).
* _<span style="color:red">**read.csv("file name")**</span> is a code for importing CSV files. You need to specify your file name between the parentheses.
