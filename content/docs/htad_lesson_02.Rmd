...
<img width='720' src='/img/htad_lesson_02_image_01.png'/>

4) After logging in, scroll down 

5) Click on the name of the survey you want to work on

<img alt = '' width='720' src='/img/htad_lesson_02_image_02.png'/>

6)  Click the “Reporting” tab

<img alt = '' width='700' src='/img/htad_lesson_02_image_03.png'/>

7)  Click the “Download Data” icon
 
<img alt = 'my new screenshot' width='700' src='/img/htad_lesson_02_image_04.png'/>
...
<img width='720' src='/img/htad_lesson_02_image_05.png'/>
...
<img width='720' src='/img/htad_lesson_02_image_06.png'/>
...
<img width='720' src='/img/htad_lesson_02_image_07.png'/>
...
<img width='720' src='/img/htad_lesson_02_image_08.png'/>
...
<img width='720' src='/img/htad_lesson_02_image_09.png'/>
...
<img width='720' src='/img/htad_lesson_02_image_10.png'/>
 
4)  In the dialogue box that opens, change “Files of type” to “Excel”.

5)  Navigate to select your dataset.
 
<img width='720' src='/img/htad_lesson_02_image_11.png'/>
