...
The examples in this guide use various datasets. 

Some of the [datasets can be found here.](/docs/quant_analysis_lab_x/)
...
A list of online guides you can refer to for assistance with SPSS. Also includes 11 laboratory assignments for SSCI202 by Dr Hangyoung Lee.
...
## Lab 6: Constructing and testing an index (Cronbach's Alpha)
...
A guide to generating a wide range of charts in SPSS.

## SPSS: Practice Datasets

Links to a range of practice datasets.




Last updated by _Dr Nicholas Harrigan_ [(nicholas.harrigan@mq.edu.au)](mailto:nicholas.harrigan@mq.edu.au)
