...
linktitle: "Quant Analysis 7: Linear Regression"
menu:
   docs:
...
# Reading
'Chapter 8: Regression' in [Andy Field, 2017. Discovering Statistics Using IBM SPSS Statistics. Sage.](https://www.amazon.com/Discovering-Statistics-Using-IBM-SPSS/dp/1446249182)
...
knitr::include_graphics("/img/htad_lesson_06_image_01.png")
```
...
```{r, echo=FALSE, out.width=400, fig.cap="", fig.align='center'}
knitr::include_graphics("/img/htad_lesson_06_image_02.png")
```
...
```{r, echo=FALSE, out.width=400, fig.cap="", fig.align='center'}
knitr::include_graphics("/img/htad_lesson_06_image_03.png")
```
...
```{r, echo=FALSE, out.width=400, fig.cap="", fig.align='center'}
knitr::include_graphics("/img/htad_lesson_06_image_04.png")
```
...
```{r, echo=FALSE, out.width=400, fig.cap="", fig.align='center'}
knitr::include_graphics("/img/htad_lesson_06_image_05.png")
```
...
```{r, echo=FALSE, out.width=400, fig.cap="", fig.align='center'}
knitr::include_graphics("/img/htad_lesson_06_image_06.png")
```
...
```{r, echo=FALSE, out.width=400, fig.cap="", fig.align='center'}
knitr::include_graphics("/img/htad_lesson_06_image_07.png")
```
...
```{r, echo=FALSE, out.width=400, fig.cap="", fig.align='center'}
knitr::include_graphics("/img/htad_lesson_06_image_08.png")
```
...
```{r, echo=FALSE, out.width=400, fig.cap="", fig.align='center'}
knitr::include_graphics("/img/htad_lesson_06_image_09.png")
```
...
```{r, echo=FALSE, out.width=400, fig.cap="", fig.align='center'}
knitr::include_graphics("/img/htad_lesson_06_image_10.png")
```
...
```{r, echo=FALSE, out.width=400, fig.cap="", fig.align='center'}
knitr::include_graphics("/img/htad_lesson_06_image_11.png")
```
