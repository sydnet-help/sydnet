...
**Week 8: Normal class but starting with 30 minute mid-term exam.** (Midterm 5%)

**Weeks 7 & 13: Student presentations (replication of analysis from an academic paper) + report due in class** (Week 7 Presentation & Report 10%; Week 13 Presentation & Report 40%)

**Week 14: In-class exam (2 hours: Online, bring laptop. Multiple choice, fill in blank, and short answer)** (Exam worth 20%)
...
* **Week 7 Presentation and report (10%)**
* **Week 8 Midsemester exam (5%)**
* **Week 13 Presentation and report (40%)**
...
Example grades and student evidence of meeting marking criteria:
55% (Pass) - attends 80% of classes, but does so with little participation beyond completing exercises
65% (Credit) - attends 90% of classes, and participates in discussion occassionally.
75% (Distinction) - attends 100% of classes, and participates actively and fully
85% (High Distinction) - attends 100% of classes, and shows deep engagement with teaching material and with other students. Shows serious preparation before class. Completes exercises at a very high standard, perhaps extending analysis beyond those immediately taught.

#### Week 7 Presentation and report (10%)

**Instructions:**

1. **Replicate a published study with public dataset:** Students are to find a published, peer reviewed academic article that uses a publically accessable dataset, and replicate the analysis presented in the paper using R.
...
6. **Consulation:** Students are expected to consult with the lecturer (Nick) before class (4pm - 6pm), in class (6pm - 9pm), and outside class (Facebook messenger, WhatsApp) to (1) confirm their choice of article, and (2) discuss any issues and problems they are having with the analysis. 

**Marking critieria:**

1. **Clear writing style:** Straight-forward, clear, easy to read writing. This means generally using short sentences, having a single coherent and easy to understand argument, and using paragraphs with topic sentences.
2. **Professional Tables and Figures:** Tables and figures should be presented like they would appear in an academic article, which means, at the least, (1) that tables are not just cut and paste from R output, (2) that tables and figures include only the necessary information, (3) that tables and figures include all appropriate information, and (4) they should be able to be interpreted on their own (without the text), and (5) all tables and figures should be referred to by number in the text. 
3. **Analysis:** Analysis should be a high quality replication of the analysis in the academic article which it comes from. Analysis may briefly extend on the analysis in the article, if space and time permits. 
4. **Explanation:** Explanation of the analysis should be simple, clear, and correctly use terminology. It should also point out the substantive significance of the results in a way that another person with a Masters Degree, but not in this area of research, could understand.
5. **R code:** R code should be as simple and tidy as possible, with brief annotated comments (after # symbols), which explain the purpose of each section of code. The R code should be in a form which the lecturer can run on their computer and replicate the analysis.

#### Week 8 Midterm exam (5%)
...
1. **Same as Week 7 Presentation & Report, but full analysis:** Instructions and marking criteria are the same as for Week 7 Presentation and Report, except that the full analysis should be presented, and should include some form of multivariate analysis (some form of regression, factor analysis, ANOVA, or similar). 
...
## Week 7: Student Presentations + Report Due (10%)

## Week 8: Midterm (30 mins - 5%) + Regression diagnostics
...
## Week 13: Student Presentations + Report Due (40%)

## Week 14: Final exam (2 hours - 20%)
