...
summary(model1)
 ...
 Call:   lm(formula = elect_2013$pol_knowledge ~ elect_2013$age_18_24)  Residuals:   Min      1Q  Median      3Q     Max  -4.8545 -2.5405  0.1455  2.1455  6.4595   Coefficients:                         Estimate Std. Error t value Pr(>|t|)     (Intercept)             4.85451    0.04792 101.312  < 2e-16 ***   elect_2013$age_18_24 -1.31396    0.19957  -6.584  5.2e-11 ***   ---   Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1  Residual standard error: 2.887 on 3849 degrees of freedom (104 observations deleted due to missingness) Multiple R-squared:  0.01114, Adjusted R-squared:  0.01088  F-statistic: 43.35 on 1 and 3849 DF,  p-value: 5.198e-11
...
# -------------------------------------------------- Example 2: A more complex model -------------------------------------------------- So let's now make a more complex model of  political engagement. I will just write the model out below. You should understand it's meaning: 
