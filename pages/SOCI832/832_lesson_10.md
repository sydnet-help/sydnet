...
## Reference: 
<http://www.strengejacke.de/sjPlot/reference/index.html>
...
For an introduction to the %>% operator see this: <https://cran.r-project.org/web/packages/magrittr/vignettes/magrittr.html> 
